namespace Tools
{
    public class Names
    {
        public const string DirectoryNameOfLocalSandbox = "LocalSandboxs";
        ...
        public const string JsonNameOfConnectionData = "BlockConnection.json";
        public static string RootNameOfToy = "RootOfToy";
        public static string RootNameOfBlock = "RootOfBlock";
        public const string CompressedSandboxName = "Sandbox.zip";
