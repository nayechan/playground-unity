...
namespace GameEditor
{
    public class PrefabManager : MonoBehaviour
    {
        ...
        //
        //
        // void AddNewPrefab(Texture2D ts, string name, IFObject info)
        // {
        //     int num = FindEmpty();
        //     _isTaken[num] = true;
        ...
        // }
        //
        // void SetButton(GameObject Box, string name, Texture2D ts, IFObject info)
        // {
        //     // 타일 이미지를 추가함.
